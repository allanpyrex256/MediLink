      ...
      {open ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/45 px-4 py-6 backdrop-blur-sm">
          <div
            ...
            className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-lg border border-slate-300 bg-white shadow-2xl shadow-slate-950/20"
          >
            ...
            <form onSubmit={handleSubmit} className="grid gap-5 p-5">
              ...
              <div className="flex flex-col-reverse gap-3 border-t border-slate-300 pt-5 sm:flex-row sm:justify-end">
