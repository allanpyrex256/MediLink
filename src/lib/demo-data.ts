...
export const demoTenant: Tenant = {
  ...
  accent_color: "#0ea5e9",
  theme: "purple",
  brand_tagline: "Daily hospital operations",
  logo_url: null,
  cover_image_url: null,
  profile_image_url: null,
  logo_approved_at: new Date("2026-05-01T08:00:00.000Z").toISOString(),
  storage_usage_mb: 418,
...
export const demoMengoTenant: Tenant = {
  ...
  primary_color: "#0f6fdc",
  accent_color: "#14b8a6",
  theme: "blue",
  brand_tagline: "Outpatient clinic operations",
  logo_url: null,
  cover_image_url: null,
  profile_image_url: null,
  logo_approved_at: new Date("2026-05-03T08:00:00.000Z").toISOString(),
  storage_usage_mb: 186,
...
export const demoMukonoTenant: Tenant = {
  ...
  accent_color: "#0ea5e9",
  theme: "green",
  brand_tagline: "Medical centre management",
  logo_url: null,
  cover_image_url: null,
  profile_image_url: null,
  logo_approved_at: new Date("2026-05-05T08:00:00.000Z").toISOString(),
  storage_usage_mb: 241,
...
export const demoPharmacyTenant: Tenant = {
  ...
  accent_color: "#f59e0b",
  theme: "green",
  brand_tagline: "Pharmacy POS and stock control",
  logo_url: null,
  cover_image_url: null,
  profile_image_url: null,
  logo_approved_at: new Date("2026-05-08T08:00:00.000Z").toISOString(),
  storage_usage_mb: 129,
...
export const demoGoodLifeTenant: Tenant = {
  ...
  accent_color: "#7c3aed",
  theme: "green",
  brand_tagline: "Branch pharmacy operations",
  logo_url: null,
  cover_image_url: null,
  profile_image_url: null,
  logo_approved_at: new Date("2026-05-09T08:00:00.000Z").toISOString(),
  storage_usage_mb: 203,
...
export const demoPharmacyPrescriptions: PrescriptionOrder[] = [
  {
    ...
    customer_phone: "+256 706 432 190",
    ...
    payment_method: "mtn_momo",
    customer_notes: "Monthly refill. Customer asked for blister pack if available.",
    ready_notification_sent_at: new Date("2026-05-14T09:00:00.000Z").toISOString(),
  ...
  },
  {
    ...
    customer_phone: "+256 778 201 044",
    ...
    delivery_address: "Plot 12 Luwum Street, near the blue gate, Kampala",
    payment_method: "airtel_money",
    customer_notes: "Call before dispatch. Patient prefers evening delivery.",
  ...
  },
  {
    ...
    customer_phone: "+256 701 552 901",
    ...
    payment_method: "cash",
    customer_notes: null,
    ready_notification_sent_at: new Date("2026-05-13T12:30:00.000Z").toISOString(),
