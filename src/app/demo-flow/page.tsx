...
const flowCards = [
  ...
  },
  {
    ...
    description: "Jump straight into Kampala Care Hospital as the hospital admin.",
  ...
  },
  {
    ...
    description: "See bookings from reception and from the public patient link.",
  ...
  },
  {
    ...
    href: "/kampala-care-hospital/book",
    action: "Book clinic visit",
    icon: Stethoscope,
    tone: "violet",
  },
  {
    title: "Hospital patient booking",
    description: "A second tenant booking page for the Jinja Children Hospital demo.",
    href: "/jinja-children-hospital/book",
  ...
  },
  {
    ...
    href: "/demo/acacia-care-pharmacy?next=/dashboard/pharmacy",
